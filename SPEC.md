...
- **Fase 3 (en marcha desde el 16/09/2026):** lecciones, documentos y preguntas, tema a tema. Traducidos: `rumania`, `estados-unidos`, `segunda-guerra`, `espana-siglo-xx`, `mundo-actual`, `guerra-fria`, `entreguerras`, `gran-guerra`, `revolucion-rusa`, `imperialismo`, `industrializacion` y `revoluciones-liberales`: toda la Edad Contemporánea. Diseño aplicado:
  ...
  - **Estado a 16/09/2026:** 12 de 37 temas traducidos, que son todos los de la Edad Contemporánea. Quedan 25, todos anteriores a 1815. Orden previsto: `revolucion-francesa`, `ilustracion`, `absolutismo`, `revolucion-cientifica` y de ahí hacia atrás.
