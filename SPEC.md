...
- **Fase 3 (en marcha desde el 16/09/2026):** lecciones, documentos y preguntas, tema a tema. Traducidos: toda la Edad Contemporánea (12 temas) más `revolucion-francesa`, `ilustracion`, `absolutismo`, `revolucion-cientifica`, `reforma`, `descubrimientos`, `renacimiento`, `crisis-siglo-xiv`, `plena-edad-media`, `andalus` y `feudalismo`: 23 de 37. Diseño aplicado:
  ...
  - **Estado a 17/09/2026:** 23 de 37 temas traducidos (toda la Edad Contemporánea más `revolucion-francesa`, `ilustracion`, `absolutismo`, `revolucion-cientifica`, `reforma`, `descubrimientos`, `renacimiento`, `crisis-siglo-xiv`, `plena-edad-media`, `andalus` y `feudalismo`). Quedan 14. Orden exacto en el array `modules` de `src/data/history.ts`: sigue `islam`, después el resto de la Edad Media, la Antigüedad y el bloque no europeo (`china-imperial`, `india`, `japon`, `africa`, `america-precolombina`).
