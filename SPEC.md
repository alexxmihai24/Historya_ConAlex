...
- **Fase 3 (en marcha desde el 16/09/2026):** lecciones, documentos y preguntas, tema a tema. Traducidos: toda la Edad Contemporánea, la Edad Moderna, la Edad Media y la Antigüedad, más `china-imperial` e `india` (34 temas). Diseño aplicado:
  ...
  - **Estado a 17/09/2026:** 34 de 37 temas traducidos. Toda Europa, la Antigüedad de Oriente Próximo, `china-imperial` e `india` están hechos. **Quedan solo 3**, en este orden en el array `modules` de `src/data/history.ts`: `japon`, `africa`, `america-precolombina`.
