...
- **Fase 3 (en marcha desde el 16/09/2026):** lecciones, documentos y preguntas, tema a tema. Traducidos: `rumania`, `estados-unidos`, `segunda-guerra`, `espana-siglo-xx`, `mundo-actual`, `guerra-fria`, `entreguerras` y `gran-guerra`. Diseño aplicado:
