...
- **Fase 3 (en marcha desde el 16/09/2026):** lecciones, documentos y preguntas, tema a tema. Traducidos: toda la Edad Contemporánea, la Edad Moderna, la Edad Media y la Antigüedad, más `china-imperial`, `india`, `japon` y `africa` (36 temas). Diseño aplicado:
  ...
  - **Estado a 17/09/2026:** 36 de 37 temas traducidos. Toda Europa, la Antigüedad de Oriente Próximo, `china-imperial`, `india`, `japon` y `africa` están hechos. **Queda solo `america-precolombina`**: al traducirlo, la fase 3 se da por completa y terminada.
