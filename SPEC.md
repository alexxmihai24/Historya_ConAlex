...
- **Fase 3 (en marcha desde el 16/09/2026):** lecciones, documentos y preguntas, tema a tema. Traducidos: toda la Edad Contemporánea, la Edad Moderna, la Edad Media y la Antigüedad (32 temas: `revolucion-francesa`, `ilustracion`, `absolutismo`, `revolucion-cientifica`, `reforma`, `descubrimientos`, `renacimiento`, `crisis-siglo-xiv`, `plena-edad-media`, `andalus`, `feudalismo`, `islam`, `bizancio`, `roma-imperio`, `roma-republica`, `helenismo`, `grecia`, `egipto`, `mesopotamia` y `prehistoria`, más los 12 de la Edad Contemporánea y `rumania`/`estados-unidos`). Diseño aplicado:
  ...
  - **Estado a 17/09/2026:** 32 de 37 temas traducidos. Toda Europa y la Antigüedad de Oriente Próximo están hechas. **Quedan solo 5, el bloque no europeo**, en este orden en el array `modules` de `src/data/history.ts`: `china-imperial`, `india`, `japon`, `africa`, `america-precolombina`.
