...
- **Fase 3 (en marcha desde el 16/09/2026):** lecciones, documentos y preguntas, tema a tema. Traducidos: toda la Edad Contemporánea (12 temas) más `revolucion-francesa`, `ilustracion` y `absolutismo`: 15 de 37. Diseño aplicado:
  ...
  - **Estado a 17/09/2026:** 15 de 37 temas traducidos (toda la Edad Contemporánea más `revolucion-francesa`, `ilustracion` y `absolutismo`). Quedan 22, todos anteriores a 1689. Orden previsto: `revolucion-cientifica` y de ahí hacia atrás.
