...
- **Fase 3 (en marcha desde el 16/09/2026):** lecciones, documentos y preguntas, tema a tema. Traducidos: toda la Edad Contemporánea (12 temas) más `revolucion-francesa`, `ilustracion`, `absolutismo`, `revolucion-cientifica`, `reforma`, `descubrimientos` y `renacimiento`: 19 de 37 (más de la mitad). Diseño aplicado:
  ...
  - **Estado a 17/09/2026:** 19 de 37 temas traducidos, más de la mitad (toda la Edad Contemporánea más `revolucion-francesa`, `ilustracion`, `absolutismo`, `revolucion-cientifica`, `reforma`, `descubrimientos` y `renacimiento`). Quedan 18. Orden exacto en el array `modules` de `src/data/history.ts`: sigue `crisis-siglo-xiv`, después el resto de la Edad Media, la Antigüedad y el bloque no europeo (`china-imperial`, `india`, `japon`, `africa`, `america-precolombina`).
