...
- **Fase 3 (en marcha desde el 16/09/2026):** lecciones, documentos y preguntas, tema a tema. Traducidos: toda la Edad Contemporánea, la Edad Moderna, la Edad Media y la Antigüedad, más `china-imperial` (33 temas). Diseño aplicado:
  ...
  - **Estado a 17/09/2026:** 33 de 37 temas traducidos. Toda Europa, la Antigüedad de Oriente Próximo y `china-imperial` están hechos. **Quedan solo 4**, en este orden en el array `modules` de `src/data/history.ts`: `india`, `japon`, `africa`, `america-precolombina`.
