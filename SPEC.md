...
- **Fase 3 (en marcha desde el 16/09/2026):** lecciones, documentos y preguntas, tema a tema. Traducidos: toda la Edad Contemporánea, la Edad Moderna, la Edad Media y la Antigüedad, más `china-imperial`, `india` y `japon` (35 temas). Diseño aplicado:
  ...
  - **Estado a 17/09/2026:** 35 de 37 temas traducidos. Toda Europa, la Antigüedad de Oriente Próximo, `china-imperial`, `india` y `japon` están hechos. **Quedan solo 2**, en este orden en el array `modules` de `src/data/history.ts`: `africa`, `america-precolombina`.
