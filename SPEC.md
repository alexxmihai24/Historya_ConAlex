...
- **Fase 3 (en marcha desde el 16/09/2026):** lecciones, documentos y preguntas, tema a tema. Traducidos: toda la Edad Contemporánea (12 temas) más `revolucion-francesa`: 13 de 37. Diseño aplicado:
  ...
  - **Estado a 17/09/2026:** 13 de 37 temas traducidos (toda la Edad Contemporánea más `revolucion-francesa`). Quedan 24, todos anteriores a 1789. Orden previsto: `ilustracion`, `absolutismo`, `revolucion-cientifica` y de ahí hacia atrás.
