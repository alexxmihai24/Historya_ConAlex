...
- **Fase 3 (en marcha desde el 16/09/2026):** lecciones, documentos y preguntas, tema a tema. Traducidos: toda la Edad Contemporánea (12 temas) más `revolucion-francesa` e `ilustracion`: 14 de 37. Diseño aplicado:
  ...
  - **Estado a 17/09/2026:** 14 de 37 temas traducidos (toda la Edad Contemporánea más `revolucion-francesa` e `ilustracion`). Quedan 23, todos anteriores a 1789. Orden previsto: `absolutismo`, `revolucion-cientifica` y de ahí hacia atrás.
