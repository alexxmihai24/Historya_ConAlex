...
update public.topics set published = false where slug not in ('andalus', 'bizancio', 'crisis-siglo-xiv', 'descubrimientos', 'egipto', 'feudalismo', 'grecia', 'helenismo', 'islam', 'mesopotamia', 'plena-edad-media', 'prehistoria', 'reforma', 'renacimiento', 'revoluciones-liberales', 'roma-imperio', 'roma-republica');
...
delete from public.questions where topic_id in (select id from public.topics where slug in ('andalus', 'bizancio', 'crisis-siglo-xiv', 'descubrimientos', 'egipto', 'feudalismo', 'grecia', 'helenismo', 'islam', 'mesopotamia', 'plena-edad-media', 'prehistoria', 'reforma', 'renacimiento', 'revoluciones-liberales', 'roma-imperio', 'roma-republica'));
