...
update public.topics set published = false where slug not in ('andalus', 'bizancio', 'egipto', 'feudalismo', 'grecia', 'helenismo', 'islam', 'mesopotamia', 'prehistoria', 'renacimiento', 'revoluciones-liberales', 'roma-imperio', 'roma-republica');
...
delete from public.questions where topic_id in (select id from public.topics where slug in ('andalus', 'bizancio', 'egipto', 'feudalismo', 'grecia', 'helenismo', 'islam', 'mesopotamia', 'prehistoria', 'renacimiento', 'revoluciones-liberales', 'roma-imperio', 'roma-republica'));
